...
export default function DeleteVolunteerButton({ documentId }: { documentId: string }) {
  ...
  return (
    <button
      ...
      className="w-full px-6 py-3 font-bold rounded-xl border-2 border-red-400 text-red-500 hover:bg-red-500 hover:text-white transition-colors duration-200"
    >
